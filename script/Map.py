...
def insert_tile(tile):
    with conn:
        c.execute(
            ...
            ":exit_y, "
            ":discovord)",
            {'coords_x': tile.coords_x, 'coords_y': tile.coords_y, 'place_name': tile.name, 'rarity': tile.rarity,
             'difficulty': tile.difficulty, 'enterable': tile.enterable, 'tile_level': tile.floor,
             'exit_x': tile.exit_x, 'exit_y': tile.exit_y, 'discovord': tile.discovord})
