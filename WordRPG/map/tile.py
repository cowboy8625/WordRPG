...
BIOMES = {
    ...
    'desert':{'movement':3, 'color':'peru', 'alpha':'D', 'symbol':'░',
            'description':'YOU ARE IN A VILLAGE',
            'resources':None,
    ...
    'lake':{'movement':2, 'color':'darkcyan', 'alpha':'L', 'symbol':'~',
            'description':'YOU ARE ON A LAKE',
            'resources':['water', 'fish'],
            'font':{'fgcolor':'CYAN','bgcolor':'BLUE','style':'NORMAL'},
            },
    'swamp':{'movement':6, 'color':'darkolivegreen', 'alpha':'S', 'symbol':'▒',
    ...
    'alpine_grassland':{'movement':2, 'color':'lightgreen', 'alpha':'A', 'symbol':'░',
